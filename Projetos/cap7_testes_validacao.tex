...
\textbf{50 testes unitários a passar}, a que acresce uma suíte de
...
Unitário    & \texttt{test\_pt\_pt}          & Pós-processamento PT-PT: substituições de vocabulário e gerúndio$\rightarrow$infinitivo (M3). \\
Unitário    & \texttt{test\_scene\_builder}  & Segmentação em cenas e atribuição foto$\rightarrow$parágrafo, e cálculo de durações (M3/M4). \\
...
suíte, com os 50 testes a passar. Os testes incidem deliberadamente sobre a
