...
\emph{renders} falhados. Globalmente, o sistema cumpre os requisitos
funcionais essenciais (\rf{1}--\rf{15}), produzindo narrativas e vídeos
coerentes a partir de arquivos familiares reais.
