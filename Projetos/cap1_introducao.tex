...
possibilidade técnica de transformar este acervo passivo num produto
...
As soluções existentes no mercado endereçam apenas parcialmente o
...
\begin{enumerate}[label=\textbf{O\arabic*.},leftmargin=*]
  ...
  animadas (efeito \emph{Ken~Burns}), a narração por síntese de voz e
  elementos cinematográficos (títulos, legendas, transições).
  \item \textbf{Disponibilizar} estas capacidades através de uma aplicação
  Web moderna, segura, multilingue e implantada na nuvem.
  \item \textbf{Garantir privacidade e baixo custo}, privilegiando
  inferência local e ferramentas de código aberto, com recurso a serviços
  de nuvem apenas como complemento.
\end{enumerate}
...
\begin{itemize}[leftmargin=*]
  ...
  português do Brasil.
  \item Uma \textbf{estratégia de IA híbrida local/nuvem}, conciliando
  privacidade (inferência local) e robustez (\emph{fallback} remoto).
  \item Uma \textbf{aplicação Web completa e implantada}, do
  \emph{frontend} ao \emph{deployment} na nuvem.
\end{itemize}
