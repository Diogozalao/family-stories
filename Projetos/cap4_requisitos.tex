...
escolher tema, tom, idioma (PT/EN) e comprimento/duração. & Must \\
...
\rf{12} & O sistema deve acompanhar operações longas e notificar quando
terminam, sem bloquear a interface (executando em segundo plano as que o
permitam). & Should \\
...
\rf{17} & O sistema deve permitir visualizar e editar a árvore de forma
interativa (pesquisar, destacar linhagem, adicionar familiares e exportar
como imagem). & Should \\
...
\Cref{fig:casos_uso} (Anexo~\ref{ap:diagramas}) apresenta o diagrama de
casos de uso.
...
\begin{itemize}[leftmargin=*]
  ...
  longas não bloqueiem a aplicação e me avisem quando terminam, para não
  ficar parado à espera.''} (\rf{12})
