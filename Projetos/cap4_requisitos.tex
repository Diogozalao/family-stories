...
\rf{12} & O sistema deve acompanhar o estado das operações longas e
notificar o utilizador quando terminam, sem bloquear a interface (executando
em segundo plano as que o permitam, como a análise de fotografias). & Should \\
