...
que se distinguem pela escala dos seus acervos de registos históricos,
...
partir do acervo do utilizador) e opera dentro de um ecossistema fechado.
...
\begin{description}[leftmargin=*]
  ...
  \emph{Runway}, \emph{Pika}, \emph{Luma} ou \emph{Kling} para, a partir
...
parentesco. \\
M3 — Narrativa & Ollama + Llama 3 / Mistral / Gemma (local); Google
Gemini Flash (camada gratuita); Hugging Face Inference (com limites). \\
...
(GPT-4, Claude) em produção, ou APIs de geração de vídeo (Runway, Pika) —
o projeto evita-os deliberadamente: inferência local com \emph{Ollama}
durante o desenvolvimento e um \emph{slideshow} programático com MoviePy
no lugar da geração de vídeo por IA.
