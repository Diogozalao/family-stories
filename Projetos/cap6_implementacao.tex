...
frequentemente incompletas (apenas o ano, intervalos, formatos ambíguos),
produzindo uma chave de ordenação consistente — essencial, dado que o
material de arquivo raramente tem datas exatas.
...
a experiência do utilizador é idêntica independentemente do ambiente.
