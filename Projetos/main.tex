...
% ---- Cor -----------------------------------------------------------
\usepackage{xcolor}
% A cor institucional azul foi substituída por preto a pedido — assim, as
% linhas da capa, as hiperligações internas e o diagrama deixam de ser azuis.
\definecolor{ubiblue}{RGB}{0,0,0}
...
\input{cap1_introducao}
\input{cap2_estado_da_arte}
\input{cap3_metodologia_tecnologias}
\input{cap4_requisitos}
\input{cap5_arquitetura_design}
\input{cap6_implementacao}
\input{cap7_testes_validacao}
\input{cap8_conclusoes}
